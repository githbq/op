...
define(function(require, exports, module) {
    ...
    var swfobject=require('../swfobject/swfobject'),
        ...
        tplHelper=require('./helper.html');

    var AUDIO_PLAYER_INDEX=0;
    var defaultAudioSrc = IBSS.COMMON_PATH + "/widget/audio-player/sound/notification.mp3"; //默认音频播放地址
    ...
    if(!(document.createElement('audio').canPlayType)){ //flash模式
        var attrs={
            "data":IBSS.COMMON_PATH + "/widget/audio-player/dewplayer/dewplayer-vol.swf"
        },params={
            "flashvars":"mp3="+defaultAudioSrc+"&javascript=on",
            //"flashvars":"mp3="+IBSS.COMMON_PATH + "/widget/audio-player/dewplayer/mp3/test1.mp3&javascript=on",
            "wmode": "transparent"
        };
