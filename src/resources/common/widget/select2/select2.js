...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatInputTooShort: function (input, min) { var n = min - input.length; return "请输入 " + n + " 个或者更多字符"; },
        formatInputTooLong: function (input, max) { var n = input.length - max; return "请删除 " + n + " 个字符"; },
        formatSelectionTooBig: function (limit) { return "最多只能选择 " + limit + " 项"; },
        formatLoadMore: function (pageNumber) { return "加载更多结果…"; },
