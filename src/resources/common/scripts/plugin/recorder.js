...
(function(){
  ...
  swfobject.embedSWF( IBSS.BASE_PATH + "/common/scripts/plugin/recorder.swf", "recorderflash", appWidth, appHeight, "11.0.0", "", flashvars, params, attributes);
