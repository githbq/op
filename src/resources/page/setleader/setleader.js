define( function(require, exports, module){
	...
	exports.init = function(){
		...
		function searchLeader(){
			util.api({
				'url': '/agent/getsuperior',
				'success': function( data ){
					console.warn( data );
					if( data.success ){
						$el.find('.content-name').text( data.value.model?data.value.model.name:'');
						$el.find('.content-email').text( data.value.model?data.value.model.email:'');
						$el.find('.content-mobile').text( data.value.model?data.value.model.mobile:'');
						$el.find('.content-phone').text( data.value.model?data.value.model.phone:'');
					}
				}
			})
		}
