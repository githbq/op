define( function( require, exports, module ) {
    ...
    var AccountDetail = MClass( Slider ).include({
		...
		saveLimeitEve:function(){
			var me = this;
			 util.api({
                'url': '/useraccount/updatejoinenterpriselimit',
                'data': {
                    'mobile': me.mobile,
					'joinLimit':me.$('.limit').val()
                },
		...
		load:function(){
			...
			//操作日志
			util.api({
                url: '/useraccount/querypagejoinenterpriselog',
                data: {
                    mobile: me.mobile,
			...
			//拦截日志
			util.api({
                url: '/useraccount/querypageinterceptjoinenterpriselog',
                data: {
                    mobile: me.mobile,
    ...
    var LoginLimitTable = MClass( M.Center ).include( {
        ...
        load: function() {
            ...
            util.api({
                url: '/useraccount/querypagejoinenterprise',
                data: {
