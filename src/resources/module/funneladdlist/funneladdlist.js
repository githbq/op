...
define( function(require, exports, module){
    ...
    var contentStr = require('./funneladdlist.html');
    ...
    var FunnelList = MClass( M.Center ).include({
        ...
        exportEve: function( e ){
            ...
            window.open( IBSS.API_PATH + '/enterprisefiling/downloadreportforvalueadded?' + param );
        },
        ...
        getList: function(){
            ...
            util.api({
                'url': '/enterprisefiling/getreportforvalueadded',
                'data': data,
