...
define(function(require, exports, module) {
    ...
    var buyMap = new Object({
        '1': '赠送',
        '2': '购买充值'
    });
    var carMap = new Object({
        '0': '未开通服务',
        '1': '限量购买',
        '2': '不限量使用'
    });
    ...
    var EntDetail = MClass(Slider).include({
        ...
        initializeDatepickers: function() {
            ...
            me.$actStartTime.datetimepicker({
                format: 'Y/m/d',
                onShow: function() {
                    var maxDate = me.$actEndTime.val() ? me.$actEndTime.val() : me.GetDateStr(-1);
                    this.setOptions({
                        maxDate: maxDate
                    });
                },
                            ...
                            _.map(data.value.model, function(obj) {
                                ...
                                switch (obj["code"]) {
                                    ...
                                    case "Service_Fee_New":
                                        strDom += " <p> <span class='title'><b>" + obj['appName'] + "</b></span></p>";
                                        break;
                                    default:
                ...
                success: function(data) {
                    ...
                    if (data.success) {
                        ...
                        if (data.model.length > 0) {
                            ...
                            me.$tbOrderList.html(me.tPOrderList({
                                content: data.model
                            }));
                ...
                success: function(data) {
                    ...
                    if (data.success) {
                        ...
                        if (data.model.page && data.model.page.content && data.model.page.content.length > 0) {
                            me.$tbOperation.html(me.tplOperation({
                                content: data.model.page.content
                            }));
                        } else {
        ...
        GetDateStr: function(AddDayCount) {
            ...
            return util.formatDate(dd.getTime(), "YYYY/MM/dd");
        },
        ...
        actDownloadEve: function(e) {
            ...
            util.api({
                ...
                url: '~/op/api/activity/big/eidkey', //第一次去请求model值
                data: {
                    enterpriseId: me.model.attrs.enterpriseId
                },
                success: function(data) {
                    if (data.success) {
                        ...
                        if (data.value.model) {
                            ...
                            function initIframe() {
                                ...
                                $('body').append(
                                    "<form  class='formClass' action=" + "/hda/bigactivity/mission/detail?" + $.param({
                                        'uuid': data.value.model,
                                        'start': startTime,
                                        'end': endTime
                                    }) + "   " + "method='POST' enctype='multipart/form-data'  id='formdown' style='display:none;'>" +
        ...
        showLaunchTime: function() {
            ...
            me.$('#saveLaunchTime').off('click').on('click', function() {
                ...
                util.api({
                    url: '/enterprise/changeappstarttime',
                    data: {
                        enterpriseId: me.ENTERPRISE_ID,
                        launchTime: new Date(me.$('#launchTime').val()).getTime()
                    },
                    success: function(data) {
                        if (data.success) {
                            util.showTip('保存成功');
        ...
        init_launchTime: function(enterpriseId) {
            ...
            util.api({
                url: '/enterprise/queryappstarttime',
                data: {
        ...
        changeCustomStatus: function() {
            ...
            util.api({
                ...
                data: {
                    ...
                    isLoginPagePersonalization: !this.model.attrs.isLoginPagePersonalization
                },
                success: function(data) {
                    if (data.success) {
                        util.showTip('更新成功');
